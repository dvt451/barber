      ...
      <div className="header__content">
         ...
         <nav data-aos="zoom-in" className="header__menu menu">
            ...
            <li className='menu__item'><NavLink className="menu__link" to="/">Home</NavLink></li>
               {
                  Menu.map((item,i)=>{
                     return <li key={i} className='menu__item'><NavLink className="menu__link" to={item}>{item}</NavLink></li>
                  })
               }
            </ul>
         </nav>
         ...
         <div className={burger ? 'burger__body _active-burger' : 'burger__body'}>
            ...
            <li className='menu__item'><NavLink onClick={()=>setBurger(false)} className="menu__link" to="/">Home</NavLink></li>
               {
                  Menu.map((item,i)=>{
                     return <li key={i} className='menu__item'><NavLink onClick={()=>setBurger(false)} className="menu__link" to={item}>{item}</NavLink></li>
                  })
               }
            </ul>
         </div>
